...
<script setup lang="ts">
  ...
  import { DoubleSide, Mesh, MeshToonMaterial, Quaternion, SphereGeometry, Vector3 } from 'three'
  ...
  const soundActions = {
    ...
    hitReceived: sounds.createAudioPlayer(
      ['spiderHitReceived1', 'spiderHitReceived2', 'spiderHitReceived3', 'spiderHitReceived4'],
      model
    ),
  }
