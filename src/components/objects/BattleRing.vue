<template>
  ...
  <primitive
    :object="resources.get('fence').scene"
    :scale="[1.5, 1.5, 1.5]"
    :position="[-12.5, 0, 9]"
    :rotate-y="Math.PI / 2"
  ></primitive>
  ...
  ></primitive>
  <primitive
    :object="resources.get('fenceBroken').scene"
    :scale="[1.5, 1.5, 1.5]"
    :position="[-12.5, 0, -9]"
    :rotate-y="Math.PI / 2"
  ></primitive>
  ...
  <primitive
    :ref="(ref) => topFencesRefs.push(ref)"
    :object="resources.get('fence', 1).scene"
    :scale="[1.5, 1.5, 1.5]"
    :position="[-9, 0, 12.5]"
  ></primitive>
  <primitive
    :ref="(ref) => topFencesRefs.push(ref)"
    :object="resources.get('fenceBroken', 1).scene"
    :scale="[1.5, 1.5, 1.5]"
    :position="[3, 0, 12.5]"
  ></primitive>
  <primitive
  ...
  <primitive
    :object="resources.get('rockPathThin').scene"
    :scale="[1.5, 1.5, 1.5]"
    :position="[-10, 0, 5]"
    :rotate-y="Math.PI / 2"
  ></primitive>
  <primitive
    :object="resources.get('rockPathSmall').scene"
    :scale="[1.5, 1.5, 1.5]"
    :position="[-8, 0, 2]"
    :rotate-y="Math.PI / 2"
  ></primitive>
