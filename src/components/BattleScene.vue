<template>
  ...
  <!-- Tree -->
  <primitive
    :object="resources.get('deadTree').scene"
    :scale="[1.9, 1.9, 1.9]"
    :position="[24, 0, -21]"
  ></primitive>
  <primitive
  ...
  ></primitive>
  <primitive
    :object="resources.get('deadTree2').scene"
    :scale="[0.7, 0.7, 0.7]"
    :position="[9, 0, -30]"
  ></primitive>
  <primitive
  ...
  ></primitive>
  <primitive
    :object="resources.get('smallDeadTree').scene"
    :scale="[1, 1, 1]"
    :position="[14, 0, -29]"
  ></primitive>
  <primitive
  ...
  ></primitive>
  <primitive
    :object="resources.get('deadTree', 0.3).scene"
    :scale="[1.4, 1.4, 1.4]"
    :position="[18, 0, -35]"
  ></primitive>
  <primitive
    :object="resources.get('deadTree', 0.4).scene"
    :scale="[1.4, 1.4, 1.4]"
    :position="[13, 0, -32]"
  ></primitive>
  <primitive
    :object="resources.get('deadTree2', 0.4).scene"
    :scale="[0.8, 0.8, 0.8]"
    :position="[22, 0, -32]"
  ></primitive>
  ...
  <primitive
    :object="resources.get('deadTree2', 0.2).scene"
    :scale="[1, 1, 1]"
    :position="[-2, 0, -35]"
  ></primitive>
  <primitive
    :object="resources.get('deadTree', 0.5).scene"
    :scale="[1.4, 1.4, 1.4]"
    :position="[13, 0, -35]"
  ></primitive>
  <primitive
    :object="resources.get('deadTree2', 0.5).scene"
    :scale="[1.1, 1.1, 1.1]"
    :position="[-5, 0, -32]"
  ></primitive>
  <primitive
    :object="resources.get('deadTree', 0.2).scene"
    :scale="[1.4, 1.4, 1.4]"
    :position="[-1, 0, -39]"
  ></primitive>
  <primitive
  ...
  <!-- Crypt -->
  <primitive
    :object="resources.get('crypt').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[-5, 0, -22]"
  ></primitive>
  <primitive
    :object="resources.get('cobweb').scene"
    :scale="[2, 2, 2]"
    :position="[-2, 0, -17]"
    :rotation="[0, -0.5, 0]"
  ></primitive>
  <primitive
    :object="resources.get('skull').scene"
    :position="[-7, 0.01, -16]"
    :rotation="[0, 0.6, 0]"
  ></primitive>
  <primitive :object="resources.get('bone').scene" :position="[-10, 0.01, -18]"></primitive>
  <primitive
    :object="resources.get('bone').scene"
    :position="[-9.5, 0.01, -18.2]"
    :rotation="[0, 2.3, 0]"
  ></primitive>
  ...
  <!--Path-->
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[-9, 0.01, -14.2]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[-6.5, 0.01, -14.2]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[-3.9, 0.01, -14.2]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[-1.3, 0.01, -14.2]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -14.2]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -16.7]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -19.2]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -21.8]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -24.3]"
  ></primitive>
  <primitive
    :object="resources.get('path').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -26.8]"
  ></primitive>
  <primitive
    :object="resources.get('path', 0.8).scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -29.4]"
  ></primitive>
  <primitive
    :object="resources.get('path', 0.4).scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -32]"
  ></primitive>
  <primitive
    :object="resources.get('path', 0.2).scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -34.5]"
  ></primitive>
  <primitive
    :object="resources.get('path', 0.1).scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[1.4, 0.01, -37]"
  ></primitive>

  <!--Sepultura-->
  <Candles :render-light="!isMobile" :position="[3.5, 0.01, -25.5]" />
  <primitive
    :object="resources.get('shovel').scene"
    :scale="[0.8, 0.8, 0.8]"
    :position="[9, 1.2, -17.8]"
    :rotation="[-0.2, -0.5, 0.1]"
  ></primitive>
  <primitive
    :object="resources.get('graveUnder').scene"
    :scale="[1.3, 1.3, 1.3]"
    :position="[6, 0.3, -21.8]"
  ></primitive>
  <primitive
    :object="resources.get('coffin').scene"
    :scale="[1.1, 1.1, 1.1]"
    :position="[10, 0.01, -21.8]"
  ></primitive>
  <primitive
    :object="resources.get('coffin').scene"
    :scale="[1.1, 1.1, 1.1]"
    :position="[11, 0.8, -19.8]"
  ...
  ></primitive>
  <primitive
    :object="resources.get('grave').scene"
    :scale="[1.2, 1.2, 1.2]"
    :position="[5.9, 0, -25.8]"
  ></primitive>
  <primitive
    :object="resources.get('ribcage').scene"
    :scale="[1.2, 1.2, 1.2]"
    :position="[5.9, 0.3, -16.8]"
    :rotation="[1, 2.5, 1]"
  ></primitive>
  ...
  <!-- Left side -->
  <primitive
    :object="resources.get('cemetary').scene"
    :scale="[4, 4, 4]"
    :position="[-19, 1, -12]"
  ></primitive>
  <primitive
  ...
  <template v-for="item in 10" :key="item">
    <primitive
      :object="resources.get('path').scene"
      :scale="[1.3, 1.3, 1.3]"
      :position="[-18.5, 0.01, -9.5 - 2.5 * -item]"
    ></primitive>
  </template>
  ...
  <primitive
    :object="resources.get('coffin2').scene"
    :scale="[1, 1, 1]"
    :position="[-21, 1.5, 6]"
    :rotation="[Math.PI / 2, 0.2, -1.2]"
  ></primitive>
  <primitive
    :object="resources.get('graveMarker').scene"
    :scale="[1, 1, 1]"
    :position="[-15, 0, 6]"
    :rotation="[0, 0.5, 0]"
  ></primitive>
  ...
  <primitive
    :object="resources.get('gravestone').scene"
    :scale="[0.8, 0.8, 0.8]"
    :position="[17, 0, -14]"
    :rotation="[0, 0.3, 0]"
  ></primitive>
  ...
  ></primitive>
  <primitive
    :object="resources.get('damagedGrave').scene"
    :scale="[0.8, 0.8, 0.8]"
    :position="[22, 0, -7]"
    :rotation="[0, -0.3, 0]"
  ></primitive>
  ...
  <primitive
    :object="resources.get('damagedGrave', 0.2).scene"
    :scale="[0.8, 0.8, 0.8]"
    :position="[-5.5, -0.35, 18]"
    :rotation="[0, -0.4, 0]"
  ></primitive>
  <primitive
    :object="resources.get('damagedGrave', 0.2).scene"
  ...
  ></primitive>
  <primitive
    :object="resources.get('gravestone', 0.2).scene"
    :scale="[0.8, 0.8, 0.8]"
    :position="[7, -0.3, 16]"
    :rotation="[0, -0.2, 0]"
  ></primitive>
  <primitive
    :object="resources.get('skull', 0.2).scene"
    :scale="[0.6, 0.6, 0.6]"
    :position="[9, 0, 18]"
    :rotation="[0, -0.4, 0]"
  ></primitive>
  <primitive
    :object="resources.get('graveMarker', 0.2).scene"
    :scale="[0.9, 0.9, 0.9]"
    :position="[-6, 0, 16]"
    :rotation="[0, -0.4, 0]"
  ></primitive>
